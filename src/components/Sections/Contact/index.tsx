...
const Contact: FC = memo(() => {
  const { headerText, description, items, imageSrc } = contact;
    ...
    <Section noPadding sectionId={SectionId.Contact}>
      <div
        ...
        <div className="z-10 w-full max-w-screen-md px-4 lg:px-0">
          <div className="flex flex-col gap-y-6 rounded-xl bg-gray-800/60 p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
                {description && <p className="prose leading-6 text-neutral-300">{description}</p>}
